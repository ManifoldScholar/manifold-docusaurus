...
// STYLED-COMPONENTS: Added an import for grabbing styles during SSR
import { ServerStyleSheet } from 'styled-components'
import {minify} from 'html-minifier-terser';
import path from 'path';
import fs from 'fs-extra';
import routes from '@generated/routes';
import packageJson from '@docusaurus/core/package.json';
...
} from '@docusaurus/core/lib/client/LinksCollector';
...
async function doRender(locals) {
  ...
  // STYLED-COMPONENTS: Wrap the app in renderToString
  ...
  // STYLED-COMPONENTS: We grab the style tags and shunt them into the head tags.
  const adjustedHeadTags = headTags.concat(sheet.getStyleTags());
