...
In the context of a [package install](./installation_v8#package-install), services are managed using the `manifold-ctl` command line tool. This tool must be executed as root or usng `sudo`.
